...
const ForgotPasswordScreen = () => {
  ...
  return (
    <View className="flex-1  p-6 bg-gray-100" style={{ marginTop: 80 }}>
      <TouchableOpacity
      ...
      <View className="flex flex-col items-start justify-start">
        ...
        <Text className="text-sm text-gray-600 mb-8 text-left">
          Dont worry! Enter your Email and we will send you a link to reset your
          password
        </Text>
      </View>
      <View className="flex flex-col items-start justify-start">
      ...
      <View className=" justify-center ">
        ...
        >
          <Text className="text-white text-left font-semibold">Send Code</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
