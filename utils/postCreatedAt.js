...
const calculateFutureTime = (diffInSeconds) => {
  ...
  if (diffInSeconds < 3600)
    return `in ${Math.floor(diffInSeconds / 60)} min${
      Math.floor(diffInSeconds / 60) !== 1 ? "s" : ""
    }`;
  if (diffInSeconds < 86400)
    return `in ${Math.floor(diffInSeconds / 3600)} hour${
      Math.floor(diffInSeconds / 3600) !== 1 ? "s" : ""
    }`;
  if (diffInSeconds < 2592000)
    return `in ${Math.floor(diffInSeconds / 86400)} day${
      Math.floor(diffInSeconds / 86400) !== 1 ? "s" : ""
    }`;
  if (diffInSeconds < 31536000)
    return `in ${Math.floor(diffInSeconds / 2592000)} month${
      Math.floor(diffInSeconds / 2592000) !== 1 ? "s" : ""
    }`;
  return `in ${Math.floor(diffInSeconds / 31536000)} year${
    Math.floor(diffInSeconds / 31536000) !== 1 ? "s" : ""
  }`;
};
